...
export const schemaOrdenValidator = z.object({
  descripcion: z
    ...
    .min(10, {
      message: "La descripción debe contener un mínimo de 10 caracteres",
    })
    .max(50, {
      message: "La descripción debe contener un máximo de 50 caracteres",
    }),
  comensales: z.coerce
    .number({
  ...
  tiempo_estimado_preparacion: z.coerce
    .number({
  ...
  jefe_cocina_id: z
    ...
    .max(50, {
      message: "El jefe de cocina debe tener como máximo 10 caracteres",
    }),
});
